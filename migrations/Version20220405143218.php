 ...
 */
final class Version20220405143218 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE suite (id INT AUTO_INCREMENT NOT NULL, suite_name VARCHAR(255) NOT NULL, suite_description LONGTEXT NOT NULL, suite_price NUMERIC(10, 2) DEFAULT NULL, suite_slug VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
